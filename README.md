...
This program retrieves currency exchange rate data from the Central Bank of Russia (ЦБРФ) in XML format and outputs it in JSON. If you specify the `--debug` parameter, additional information will be provided in a human-readable format.
